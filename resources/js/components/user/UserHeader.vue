...
import { LayoutGrid, Menu, ShoppingCart, ScrollText } from 'lucide-vue-next';
            ...
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="relative flex items-center space-x-1">
                        <Link :href="history()" 
                            class="group relative flex h-9 w-9 cursor-pointer items-center justify-center">
                            <ScrollText class="size-5 opacity-80 group-hover:opacity-100" />
                        </Link>
                        <Link :href="view()"
                            class="group relative flex h-9 w-9 cursor-pointer items-center justify-center">
